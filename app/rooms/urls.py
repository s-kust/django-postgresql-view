...
router.register(r"window_fittings", views.WindowFittingsViewSet, basename="window_fittings")
...
router.register(r"rooms_v3", views.RoomsRelatedV3ViewSet, basename="rooms_v3")
router.register(r"rooms_mat_view", views.RoomsRelatedObjectsViewSet, basename="rooms_mat_view")
...
router.register(r"decorations", views.DecorationViewSet, basename="decorations")
