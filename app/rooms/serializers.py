...
class DecorationSerializer(serializers.ModelSerializer, EagerLoadingMixin):
    ...
    def get_or_create_souvenirs(self, souvenirs):
        ...
        for souvenir in souvenirs:
            souvenir_instance, created = Souvenir.objects.get_or_create(pk=souvenir.get("id"), defaults=souvenir)
    ...
    def create_or_update_souvenirs(self, souvenirs):
        ...
        souvenir_ids = []
        for souvenir in souvenirs:
            souvenir_instance, created = Souvenir.objects.update_or_create(pk=souvenir.get("id"), defaults=souvenir)
            souvenir_ids.append(souvenir_instance.pk)
        return souvenir_ids
...
class RoomsRelatedV3Serializer(serializers.ModelSerializer):
    class Meta:
        model = RoomWithRelatedObjsV3
        fields = "__all__"
